...
public class GameManager : MonoBehaviour
{
    ...
    private float[] levelScoreImportance = new float[] { 100f, 150f, 200f, 250f, 300f, 350f, 400f};  // those values stores int which is added to level score value after completing level, index == level
